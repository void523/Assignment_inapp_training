...
while True:
    info = int(input('Enter the round for which you need the information  >>\t'))
    print('\n')
    print("Player's choice = {}\nComputer's choice = {}\n{} won round {}".format(game_dict[info][0],game_dict[info][1],game_dict[info][2],info))
    print('\n')
    qn = input("Do you want information regardingS other rounds (yes/no) >> ")
    if qn == 'yes':
        continue
    elif qn == 'no':
        exit()
